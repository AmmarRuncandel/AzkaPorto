...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/azka-mudhamatan-83640a34a?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Azka",
    icon: Instagram,
    url: "https://www.instagram.com/azkamdhmtn?igsh=MThmanZ3YWhsN21jaQ==",
    color: "#E4405F",
...

  {
    ...
    subText: "+62 89519858776",
    icon: WhatsappIcon,
    url: "https://wa.me/6289519858776",
    color: "#25D366",
  ...
  },
  {
    ...
    subText: "+62 89519858776",
    icon: Send,
    url: "https://t.me/+6289519858776",
    color: "#229ED9",
    gradient: "from-[#229ED9] to-[#27A7E7]",
  },
  {
    name: "TikTok",
    displayName: "Tiktok",
    ...
    url: "https://github.com/AmmarRuncandel",
    color: "black",
...
const SocialLinks = () => {
  ...
  const [instagram, whatsapp, telegram, tiktok] = otherLinks;
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        >
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-sm text-textMuted group-hover:text-textMuted transition-colors duration-300">
                {linkedIn.subText}
              </span>
            </div>
          </div>
          ...
          {/* External Link */}
          <ExternalLink
            className="relative w-5 h-5 text-[#93aaa8] group-hover:text-white
          ...
          {[instagram, whatsapp].map((link, index) => (
            ...
            >
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span className="text-xs text-textMuted truncate group-hover:text-textMuted transition-colors duration-300">
                  {link.subText}
                </span>
              </div>

              <ExternalLink
                className="w-4 h-4 text-[#93aaa8] group-hover:text-white ml-auto
                                       opacity-0 group-hover:opacity-100 transition-all duration-300
        ...
        {/* Third Row - Telegram & TikTok */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[telegram, tiktok].map((link, index) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
